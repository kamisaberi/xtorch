...
{
    class GradientCheckpointing : public torch::optim::Optimizer {
    public:
        explicit GradientCheckpointing(std::vector<torch::Tensor>&& parameters, double lr = 0.01, double momentum = 0.9);
