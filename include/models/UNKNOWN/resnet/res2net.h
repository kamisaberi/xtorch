...
namespace xt::models {
    ...
    struct Res2Net : BaseModel {
        ...
        Res2Net(vector<int> layers, int num_classes = 10, int in_channels = 3 /* input channels */);

        Res2Net(std::vector<int> layers, int num_classes, int in_channels, std::vector<int64_t> input_shape);
