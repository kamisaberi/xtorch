...
namespace xt::models {
    ...
    struct ResNetRS : BaseModel {
        ...
        ResNetRS(vector<int> layers, int num_classes = 10, int in_channels = 3 /* input channels */);

        ResNetRS(std::vector<int> layers, int num_classes, int in_channels, std::vector<int64_t> input_shape);
