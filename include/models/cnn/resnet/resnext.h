...
namespace xt::models {
    ...
    struct ResNext : BaseModel {
        ...
        ResNext(vector<int> layers, int num_classes = 10, int in_channels = 3 /* input channels */);

        ResNext(std::vector<int> layers, int num_classes, int in_channels, std::vector<int64_t> input_shape);
