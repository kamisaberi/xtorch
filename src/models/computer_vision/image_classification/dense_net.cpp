#include <models/computer_vision/image_classification/dense_net.h>
...
namespace xt::models
{
    ...
    DenseNet121::DenseNet121(int num_classes, int growth_rate, int init_channels)
    {
        ...
        dense3 = register_module("dense3", std::make_shared<DenseBlock>(/*num_layers*/24, num_features, growth_rate));
        num_features += 24 * growth_rate;
        trans3 = register_module("trans3", std::make_shared<TransitionLayer>(num_features, num_features / 2));
        num_features /= 2;

        dense4 = register_module("dense4", std::make_shared<DenseBlock>(/*num_layers*/16, num_features, growth_rate));
        num_features += 16 * growth_rate;
    ...
    DenseNet169::DenseNet169(int num_classes, int growth_rate, int init_channels)
    {
        ...
        dense3 = register_module("dense3", std::make_shared<DenseBlock>(/*num_layers*/32, num_features, growth_rate));
        num_features += 32 * growth_rate;
        trans3 = register_module("trans3", std::make_shared<TransitionLayer>(num_features, num_features / 2));
        num_features /= 2;
