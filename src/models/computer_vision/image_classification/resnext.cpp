...
namespace xt::models {
    ...
    ResNeXtBlockImpl::ResNeXtBlockImpl(int in_channels, int out_channels, int stride, int cardinality,
    ...
    ResNeXtImpl::ResNeXtImpl(int num_blocks1, int num_blocks2, int num_blocks3, int cardinality, int bottleneck_width,
                             int num_classes = 10) {
        // --- Stem for MNIST ---
