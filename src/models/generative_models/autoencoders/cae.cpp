...
// struct CAEImpl : torch::nn::Module {
//     CAEImpl(int latent_dim = 128) {
//         // Encoder
...
//         ); // [1, H, W]
//
//         return {img_tensor, img_tensor}; // Input and target are the same for CAE
//     }
//
...
//         CAE model(128); // Latent dimension of 128
//         model->to(device);
...
//
//         // Save model
//         torch::save(model, "cae.pt");
//         std::cout << "Training complete. Model saved as cae.pt" << std::endl;
//
//         // Inference example
//         model->eval();
...
//         cv::imwrite("reconstructed_cae_image.jpg", reconstructed);
//         std::cout << "Reconstructed image saved as reconstructed_cae_image.jpg" << std::endl;
//
