...
{
    GradientCheckpointing::GradientCheckpointing(std::vector<torch::Tensor>&& parameters, double lr, double momentum)
    ...
    torch::Tensor GradientCheckpointing::step(LossClosure closure)
    {
        return torch::Tensor();
    }
}
