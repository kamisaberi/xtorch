...
{
    AudioDataset::AudioDataset(const std::string& audio_dir, const std::string& label_file)
    {
    ...
    torch::data::Example<> AudioDataset::get(size_t index) override
    {
    ...
    torch::optional<size_t> AudioDataset::size() const override
    {
        return files.size();
    }
}
