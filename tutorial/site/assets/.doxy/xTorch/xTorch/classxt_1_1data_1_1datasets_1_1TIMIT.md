...
# Class xt::data::datasets::TIMIT



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**TIMIT**](classxt_1_1data_1_1datasets_1_1TIMIT.md)
...
| Type | Name |
| ---: | :--- |
|   | [**TIMIT**](#function-timit-14) (const std::string & root) <br> |
|   | [**TIMIT**](#function-timit-24) (const std::string & root, DataMode mode) <br> |
|   | [**TIMIT**](#function-timit-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**TIMIT**](#function-timit-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::TIMIT::TIMIT (
