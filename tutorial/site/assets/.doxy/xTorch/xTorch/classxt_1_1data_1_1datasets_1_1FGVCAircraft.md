...
# Class xt::data::datasets::FGVCAircraft



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**FGVCAircraft**](classxt_1_1data_1_1datasets_1_1FGVCAircraft.md)
...
| Type | Name |
| ---: | :--- |
|   | [**FGVCAircraft**](#function-fgvcaircraft-14) (const std::string & root) <br> |
|   | [**FGVCAircraft**](#function-fgvcaircraft-24) (const std::string & root, DataMode mode) <br> |
|   | [**FGVCAircraft**](#function-fgvcaircraft-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**FGVCAircraft**](#function-fgvcaircraft-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function FGVCAircraft [1/4]

```C++
explicit xt::data::datasets::FGVCAircraft::FGVCAircraft (
...
### function FGVCAircraft [2/4]

```C++
xt::data::datasets::FGVCAircraft::FGVCAircraft (
    const std::string & root,
    DataMode mode
) 
```
