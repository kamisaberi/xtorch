...
# Class xt::data::datasets::PCAM



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**PCAM**](classxt_1_1data_1_1datasets_1_1PCAM.md)
...
| Type | Name |
| ---: | :--- |
|   | [**PCAM**](#function-pcam-14) (const std::string & root) <br> |
|   | [**PCAM**](#function-pcam-24) (const std::string & root, DataMode mode) <br> |
|   | [**PCAM**](#function-pcam-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**PCAM**](#function-pcam-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::PCAM::PCAM (
