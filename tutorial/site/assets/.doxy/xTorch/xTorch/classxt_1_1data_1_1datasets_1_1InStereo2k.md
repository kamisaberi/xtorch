...
# Class xt::data::datasets::InStereo2k



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**InStereo2k**](classxt_1_1data_1_1datasets_1_1InStereo2k.md)
...
| Type | Name |
| ---: | :--- |
|   | [**InStereo2k**](#function-instereo2k-14) (const std::string & root) <br> |
|   | [**InStereo2k**](#function-instereo2k-24) (const std::string & root, DataMode mode) <br> |
|   | [**InStereo2k**](#function-instereo2k-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**InStereo2k**](#function-instereo2k-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function InStereo2k [1/4]

```C++
explicit xt::data::datasets::InStereo2k::InStereo2k (
...
### function InStereo2k [2/4]

```C++
xt::data::datasets::InStereo2k::InStereo2k (
    const std::string & root,
    DataMode mode
) 
```
