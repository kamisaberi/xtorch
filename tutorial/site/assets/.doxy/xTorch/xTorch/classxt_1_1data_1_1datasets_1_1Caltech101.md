...
# Class xt::data::datasets::Caltech101



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Caltech101**](classxt_1_1data_1_1datasets_1_1Caltech101.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Caltech101**](#function-caltech101-14) (const std::string & root) <br> |
|   | [**Caltech101**](#function-caltech101-24) (const std::string & root, DataMode mode) <br> |
|   | [**Caltech101**](#function-caltech101-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Caltech101**](#function-caltech101-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Caltech101 [1/4]

```C++
explicit xt::data::datasets::Caltech101::Caltech101 (
...
### function Caltech101 [2/4]

```C++
xt::data::datasets::Caltech101::Caltech101 (
    const std::string & root,
    DataMode mode
) 
```
