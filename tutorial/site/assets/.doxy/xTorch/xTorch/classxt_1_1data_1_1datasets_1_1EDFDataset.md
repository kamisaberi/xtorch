...
# Class xt::data::datasets::EDFDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**EDFDataset**](classxt_1_1data_1_1datasets_1_1EDFDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**EDFDataset**](#function-edfdataset-13) (const std::string & file\_path) <br> |
|   | [**EDFDataset**](#function-edfdataset-23) (const std::string & file\_path, DataMode mode) <br> |
|   | [**EDFDataset**](#function-edfdataset-33) (const std::string & file\_path, DataMode mode, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function EDFDataset [1/3]

```C++
xt::data::datasets::EDFDataset::EDFDataset (
