...
# Class xt::data::datasets::StackedTextDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**StackedTextDataset**](classxt_1_1data_1_1datasets_1_1StackedTextDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**StackedTextDataset**](#function-stackedtextdataset-14) (const std::string & folder\_path) <br> |
|   | [**StackedTextDataset**](#function-stackedtextdataset-24) (const std::string & folder\_path, DataMode mode) <br> |
|   | [**StackedTextDataset**](#function-stackedtextdataset-34) (const std::string & folder\_path, DataMode mode, bool load\_sub\_folders) <br> |
|   | [**StackedTextDataset**](#function-stackedtextdataset-44) (const std::string & folder\_path, DataMode mode, bool load\_sub\_folders, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function StackedTextDataset [1/4]

```C++
xt::data::datasets::StackedTextDataset::StackedTextDataset (
...
### function StackedTextDataset [2/4]
...
### function StackedTextDataset [3/4]
...
### function StackedTextDataset [4/4]
