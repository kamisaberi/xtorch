...
# Class xt::data::datasets::SpeechCommands



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SpeechCommands**](classxt_1_1data_1_1datasets_1_1SpeechCommands.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SpeechCommands**](#function-speechcommands-14) (const std::string & root) <br> |
|   | [**SpeechCommands**](#function-speechcommands-24) (const std::string & root, DataMode mode) <br> |
|   | [**SpeechCommands**](#function-speechcommands-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SpeechCommands**](#function-speechcommands-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function SpeechCommands [1/4]

```C++
explicit xt::data::datasets::SpeechCommands::SpeechCommands (
...
### function SpeechCommands [2/4]

```C++
xt::data::datasets::SpeechCommands::SpeechCommands (
    const std::string & root,
    DataMode mode
) 
```
