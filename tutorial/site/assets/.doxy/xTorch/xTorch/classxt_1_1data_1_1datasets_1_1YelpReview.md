...
# Class xt::data::datasets::YelpReview



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**YelpReview**](classxt_1_1data_1_1datasets_1_1YelpReview.md)
...
| Type | Name |
| ---: | :--- |
|   | [**YelpReview**](#function-yelpreview-14) (const std::string & root) <br> |
|   | [**YelpReview**](#function-yelpreview-24) (const std::string & root, DataMode mode) <br> |
|   | [**YelpReview**](#function-yelpreview-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**YelpReview**](#function-yelpreview-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function YelpReview [1/4]

```C++
explicit xt::data::datasets::YelpReview::YelpReview (
...
### function YelpReview [2/4]

```C++
xt::data::datasets::YelpReview::YelpReview (
    const std::string & root,
    DataMode mode
) 
```
