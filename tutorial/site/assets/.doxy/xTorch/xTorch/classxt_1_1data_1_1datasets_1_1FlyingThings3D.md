...
# Class xt::data::datasets::FlyingThings3D



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**FlyingThings3D**](classxt_1_1data_1_1datasets_1_1FlyingThings3D.md)
...
| Type | Name |
| ---: | :--- |
|   | [**FlyingThings3D**](#function-flyingthings3d-14) (const std::string & root) <br> |
|   | [**FlyingThings3D**](#function-flyingthings3d-24) (const std::string & root, DataMode mode) <br> |
|   | [**FlyingThings3D**](#function-flyingthings3d-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**FlyingThings3D**](#function-flyingthings3d-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function FlyingThings3D [1/4]

```C++
explicit xt::data::datasets::FlyingThings3D::FlyingThings3D (
...
### function FlyingThings3D [2/4]

```C++
xt::data::datasets::FlyingThings3D::FlyingThings3D (
    const std::string & root,
    DataMode mode
) 
```
