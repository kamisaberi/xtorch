...
# Class xt::data::datasets::MNLI



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**MNLI**](classxt_1_1data_1_1datasets_1_1MNLI.md)
...
| Type | Name |
| ---: | :--- |
|   | [**MNLI**](#function-mnli-14) (const std::string & root) <br> |
|   | [**MNLI**](#function-mnli-24) (const std::string & root, DataMode mode) <br> |
|   | [**MNLI**](#function-mnli-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**MNLI**](#function-mnli-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::MNLI::MNLI (
