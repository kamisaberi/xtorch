...
# Class xt::data::datasets::Caltech256



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Caltech256**](classxt_1_1data_1_1datasets_1_1Caltech256.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Caltech256**](#function-caltech256-14) (const std::string & root) <br> |
|   | [**Caltech256**](#function-caltech256-24) (const std::string & root, DataMode mode) <br> |
|   | [**Caltech256**](#function-caltech256-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Caltech256**](#function-caltech256-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Caltech256 [1/4]

```C++
explicit xt::data::datasets::Caltech256::Caltech256 (
...
### function Caltech256 [2/4]

```C++
xt::data::datasets::Caltech256::Caltech256 (
    const std::string & root,
    DataMode mode
) 
```
