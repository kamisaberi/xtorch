...
# Class xt::data::datasets::EnWik



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**EnWik**](classxt_1_1data_1_1datasets_1_1EnWik.md)
...
| Type | Name |
| ---: | :--- |
|   | [**EnWik**](#function-enwik-14) (const std::string & root) <br> |
|   | [**EnWik**](#function-enwik-24) (const std::string & root, DataMode mode) <br> |
|   | [**EnWik**](#function-enwik-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**EnWik**](#function-enwik-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::EnWik::EnWik (
