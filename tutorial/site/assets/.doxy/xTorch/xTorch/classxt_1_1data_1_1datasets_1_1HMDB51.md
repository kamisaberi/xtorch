...
# Class xt::data::datasets::HMDB51



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**HMDB51**](classxt_1_1data_1_1datasets_1_1HMDB51.md)
...
| Type | Name |
| ---: | :--- |
|   | [**HMDB51**](#function-hmdb51-14) (const std::string & root) <br> |
|   | [**HMDB51**](#function-hmdb51-24) (const std::string & root, DataMode mode) <br> |
|   | [**HMDB51**](#function-hmdb51-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**HMDB51**](#function-hmdb51-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::HMDB51::HMDB51 (
...
```C++
xt::data::datasets::HMDB51::HMDB51 (
    const std::string & root,
    DataMode mode
) 
```
