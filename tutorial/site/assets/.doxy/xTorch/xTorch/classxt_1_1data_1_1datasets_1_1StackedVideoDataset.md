...
# Class xt::data::datasets::StackedVideoDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**StackedVideoDataset**](classxt_1_1data_1_1datasets_1_1StackedVideoDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**StackedVideoDataset**](#function-stackedvideodataset-14) (const std::string & folder\_path) <br> |
|   | [**StackedVideoDataset**](#function-stackedvideodataset-24) (const std::string & folder\_path, DataMode mode) <br> |
|   | [**StackedVideoDataset**](#function-stackedvideodataset-34) (const std::string & folder\_path, DataMode mode, bool load\_sub\_folders) <br> |
|   | [**StackedVideoDataset**](#function-stackedvideodataset-44) (const std::string & folder\_path, DataMode mode, bool load\_sub\_folders, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function StackedVideoDataset [1/4]

```C++
xt::data::datasets::StackedVideoDataset::StackedVideoDataset (
...
### function StackedVideoDataset [2/4]
...
### function StackedVideoDataset [3/4]
...
### function StackedVideoDataset [4/4]
