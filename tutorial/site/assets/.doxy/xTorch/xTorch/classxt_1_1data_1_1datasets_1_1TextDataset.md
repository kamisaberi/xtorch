...
# Class xt::data::datasets::TextDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**TextDataset**](classxt_1_1data_1_1datasets_1_1TextDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**TextDataset**](#function-textdataset-13) (const std::string & file\_path) <br> |
|   | [**TextDataset**](#function-textdataset-23) (const std::string & file\_path, DataMode mode) <br> |
|   | [**TextDataset**](#function-textdataset-33) (const std::string & file\_path, DataMode mode, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function TextDataset [1/3]

```C++
xt::data::datasets::TextDataset::TextDataset (
