...
# Class xt::data::datasets::CocoCaptions



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**CocoCaptions**](classxt_1_1data_1_1datasets_1_1CocoCaptions.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CocoCaptions**](#function-cococaptions-14) (const std::string & root) <br> |
|   | [**CocoCaptions**](#function-cococaptions-24) (const std::string & root, DataMode mode) <br> |
|   | [**CocoCaptions**](#function-cococaptions-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**CocoCaptions**](#function-cococaptions-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function CocoCaptions [1/4]

```C++
explicit xt::data::datasets::CocoCaptions::CocoCaptions (
...
### function CocoCaptions [2/4]

```C++
xt::data::datasets::CocoCaptions::CocoCaptions (
    const std::string & root,
    DataMode mode
) 
```
