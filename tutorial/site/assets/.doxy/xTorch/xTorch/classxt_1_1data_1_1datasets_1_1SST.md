...
# Class xt::data::datasets::SST



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SST**](classxt_1_1data_1_1datasets_1_1SST.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SST**](#function-sst-14) (const std::string & root) <br> |
|   | [**SST**](#function-sst-24) (const std::string & root, DataMode mode) <br> |
|   | [**SST**](#function-sst-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SST**](#function-sst-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::SST::SST (
