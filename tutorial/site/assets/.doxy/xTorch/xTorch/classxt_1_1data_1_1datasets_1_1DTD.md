...
# Class xt::data::datasets::DTD



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**DTD**](classxt_1_1data_1_1datasets_1_1DTD.md)
...
| Type | Name |
| ---: | :--- |
|   | [**DTD**](#function-dtd-14) (const std::string & root) <br> |
|   | [**DTD**](#function-dtd-24) (const std::string & root, DataMode mode) <br> |
|   | [**DTD**](#function-dtd-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**DTD**](#function-dtd-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::DTD::DTD (
