...
# Class xt::data::datasets::UrbanSound



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**UrbanSound**](classxt_1_1data_1_1datasets_1_1UrbanSound.md)
...
| Type | Name |
| ---: | :--- |
|   | [**UrbanSound**](#function-urbansound-14) (const std::string & root) <br> |
|   | [**UrbanSound**](#function-urbansound-24) (const std::string & root, DataMode mode) <br> |
|   | [**UrbanSound**](#function-urbansound-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**UrbanSound**](#function-urbansound-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function UrbanSound [1/4]

```C++
explicit xt::data::datasets::UrbanSound::UrbanSound (
...
### function UrbanSound [2/4]

```C++
xt::data::datasets::UrbanSound::UrbanSound (
    const std::string & root,
    DataMode mode
) 
```
