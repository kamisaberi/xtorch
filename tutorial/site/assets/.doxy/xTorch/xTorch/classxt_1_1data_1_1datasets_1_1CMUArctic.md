...
# Class xt::data::datasets::CMUArctic



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**CMUArctic**](classxt_1_1data_1_1datasets_1_1CMUArctic.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CMUArctic**](#function-cmuarctic-14) (const std::string & root) <br> |
|   | [**CMUArctic**](#function-cmuarctic-24) (const std::string & root, DataMode mode) <br> |
|   | [**CMUArctic**](#function-cmuarctic-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**CMUArctic**](#function-cmuarctic-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function CMUArctic [1/4]

```C++
explicit xt::data::datasets::CMUArctic::CMUArctic (
...
### function CMUArctic [2/4]

```C++
xt::data::datasets::CMUArctic::CMUArctic (
    const std::string & root,
    DataMode mode
) 
```
