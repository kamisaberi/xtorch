...
# Class xt::data::datasets::SBU



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SBU**](classxt_1_1data_1_1datasets_1_1SBU.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SBU**](#function-sbu-14) (const std::string & root) <br> |
|   | [**SBU**](#function-sbu-24) (const std::string & root, DataMode mode) <br> |
|   | [**SBU**](#function-sbu-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SBU**](#function-sbu-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::SBU::SBU (
