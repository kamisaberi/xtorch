...
# Class xt::data::datasets::VOCDetection



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**VOCDetection**](classxt_1_1data_1_1datasets_1_1VOCDetection.md)
...
| Type | Name |
| ---: | :--- |
|   | [**VOCDetection**](#function-vocdetection-14) (const std::string & root) <br> |
|   | [**VOCDetection**](#function-vocdetection-24) (const std::string & root, DataMode mode) <br> |
|   | [**VOCDetection**](#function-vocdetection-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**VOCDetection**](#function-vocdetection-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function VOCDetection [1/4]

```C++
explicit xt::data::datasets::VOCDetection::VOCDetection (
...
### function VOCDetection [2/4]

```C++
xt::data::datasets::VOCDetection::VOCDetection (
    const std::string & root,
    DataMode mode
) 
```
