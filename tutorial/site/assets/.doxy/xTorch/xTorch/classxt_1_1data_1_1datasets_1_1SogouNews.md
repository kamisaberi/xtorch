...
# Class xt::data::datasets::SogouNews



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SogouNews**](classxt_1_1data_1_1datasets_1_1SogouNews.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SogouNews**](#function-sogounews-14) (const std::string & root) <br> |
|   | [**SogouNews**](#function-sogounews-24) (const std::string & root, DataMode mode) <br> |
|   | [**SogouNews**](#function-sogounews-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SogouNews**](#function-sogounews-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function SogouNews [1/4]

```C++
explicit xt::data::datasets::SogouNews::SogouNews (
...
### function SogouNews [2/4]

```C++
xt::data::datasets::SogouNews::SogouNews (
    const std::string & root,
    DataMode mode
) 
```
