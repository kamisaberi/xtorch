...
# Class xt::data::datasets::Kitti2015Stereo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Kitti2015Stereo**](classxt_1_1data_1_1datasets_1_1Kitti2015Stereo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Kitti2015Stereo**](#function-kitti2015stereo-14) (const std::string & root) <br> |
|   | [**Kitti2015Stereo**](#function-kitti2015stereo-24) (const std::string & root, DataMode mode) <br> |
|   | [**Kitti2015Stereo**](#function-kitti2015stereo-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Kitti2015Stereo**](#function-kitti2015stereo-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Kitti2015Stereo [1/4]

```C++
explicit xt::data::datasets::Kitti2015Stereo::Kitti2015Stereo (
...
### function Kitti2015Stereo [2/4]

```C++
xt::data::datasets::Kitti2015Stereo::Kitti2015Stereo (
    const std::string & root,
    DataMode mode
) 
```
