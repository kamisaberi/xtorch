...
# Class xt::data::datasets::FlyingChairs



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**FlyingChairs**](classxt_1_1data_1_1datasets_1_1FlyingChairs.md)
...
| Type | Name |
| ---: | :--- |
|   | [**FlyingChairs**](#function-flyingchairs-14) (const std::string & root) <br> |
|   | [**FlyingChairs**](#function-flyingchairs-24) (const std::string & root, DataMode mode) <br> |
|   | [**FlyingChairs**](#function-flyingchairs-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**FlyingChairs**](#function-flyingchairs-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function FlyingChairs [1/4]

```C++
explicit xt::data::datasets::FlyingChairs::FlyingChairs (
...
### function FlyingChairs [2/4]

```C++
xt::data::datasets::FlyingChairs::FlyingChairs (
    const std::string & root,
    DataMode mode
) 
```
