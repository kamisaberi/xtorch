...
# Class xt::data::datasets::CelebA



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**CelebA**](classxt_1_1data_1_1datasets_1_1CelebA.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CelebA**](#function-celeba-14) (const std::string & root) <br> |
|   | [**CelebA**](#function-celeba-24) (const std::string & root, DataMode mode) <br> |
|   | [**CelebA**](#function-celeba-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**CelebA**](#function-celeba-44) (const std::string & root, DataMode mode, bool download, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
```C++
explicit xt::data::datasets::CelebA::CelebA (
...
```C++
xt::data::datasets::CelebA::CelebA (
    const std::string & root,
    DataMode mode
) 
```
