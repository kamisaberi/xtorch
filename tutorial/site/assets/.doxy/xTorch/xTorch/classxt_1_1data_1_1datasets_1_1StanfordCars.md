...
# Class xt::data::datasets::StanfordCars



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**StanfordCars**](classxt_1_1data_1_1datasets_1_1StanfordCars.md)
...
| Type | Name |
| ---: | :--- |
|   | [**StanfordCars**](#function-stanfordcars-14) (const std::string & root) <br> |
|   | [**StanfordCars**](#function-stanfordcars-24) (const std::string & root, DataMode mode) <br> |
|   | [**StanfordCars**](#function-stanfordcars-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**StanfordCars**](#function-stanfordcars-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function StanfordCars [1/4]

```C++
explicit xt::data::datasets::StanfordCars::StanfordCars (
...
### function StanfordCars [2/4]

```C++
xt::data::datasets::StanfordCars::StanfordCars (
    const std::string & root,
    DataMode mode
) 
```
