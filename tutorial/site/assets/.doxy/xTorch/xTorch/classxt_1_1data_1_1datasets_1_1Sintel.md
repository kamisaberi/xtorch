...
# Class xt::data::datasets::Sintel



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Sintel**](classxt_1_1data_1_1datasets_1_1Sintel.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Sintel**](#function-sintel-14) (const std::string & root) <br> |
|   | [**Sintel**](#function-sintel-24) (const std::string & root, DataMode mode) <br> |
|   | [**Sintel**](#function-sintel-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Sintel**](#function-sintel-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::Sintel::Sintel (
...
```C++
xt::data::datasets::Sintel::Sintel (
    const std::string & root,
    DataMode mode
) 
```
