...
# Class xt::data::datasets::SVHN



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SVHN**](classxt_1_1data_1_1datasets_1_1SVHN.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SVHN**](#function-svhn-14) (const std::string & root) <br> |
|   | [**SVHN**](#function-svhn-24) (const std::string & root, DataMode mode) <br> |
|   | [**SVHN**](#function-svhn-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SVHN**](#function-svhn-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::SVHN::SVHN (
