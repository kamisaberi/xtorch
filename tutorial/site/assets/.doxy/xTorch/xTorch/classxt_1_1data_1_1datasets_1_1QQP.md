...
# Class xt::data::datasets::QQP



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**QQP**](classxt_1_1data_1_1datasets_1_1QQP.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QQP**](#function-qqp-14) (const std::string & root) <br> |
|   | [**QQP**](#function-qqp-24) (const std::string & root, DataMode mode) <br> |
|   | [**QQP**](#function-qqp-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**QQP**](#function-qqp-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::QQP::QQP (
