...
# Class xt::data::datasets::Kinetics



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Kinetics**](classxt_1_1data_1_1datasets_1_1Kinetics.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Kinetics**](#function-kinetics-14) (const std::string & root) <br> |
|   | [**Kinetics**](#function-kinetics-24) (const std::string & root, DataMode mode) <br> |
|   | [**Kinetics**](#function-kinetics-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Kinetics**](#function-kinetics-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Kinetics [1/4]

```C++
explicit xt::data::datasets::Kinetics::Kinetics (
...
### function Kinetics [2/4]

```C++
xt::data::datasets::Kinetics::Kinetics (
    const std::string & root,
    DataMode mode
) 
```
...
------------------------------
The documentation for this class was generated from the following file `/home/kami/Documents/cpp/models/include/datasets/video/kinetics.h`
