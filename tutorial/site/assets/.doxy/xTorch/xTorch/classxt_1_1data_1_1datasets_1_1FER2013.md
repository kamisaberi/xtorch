...
# Class xt::data::datasets::FER2013



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**FER2013**](classxt_1_1data_1_1datasets_1_1FER2013.md)
...
| Type | Name |
| ---: | :--- |
|   | [**FER2013**](#function-fer2013-14) (const std::string & root) <br> |
|   | [**FER2013**](#function-fer2013-24) (const std::string & root, DataMode mode) <br> |
|   | [**FER2013**](#function-fer2013-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**FER2013**](#function-fer2013-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function FER2013 [1/4]

```C++
explicit xt::data::datasets::FER2013::FER2013 (
...
### function FER2013 [2/4]

```C++
xt::data::datasets::FER2013::FER2013 (
    const std::string & root,
    DataMode mode
) 
```
