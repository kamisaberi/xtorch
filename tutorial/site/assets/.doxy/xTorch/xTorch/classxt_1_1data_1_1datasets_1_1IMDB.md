...
# Class xt::data::datasets::IMDB



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**IMDB**](classxt_1_1data_1_1datasets_1_1IMDB.md)
...
| Type | Name |
| ---: | :--- |
|   | [**IMDB**](#function-imdb-14) (const std::string & root) <br> |
|   | [**IMDB**](#function-imdb-24) (const std::string & root, DataMode mode) <br> |
|   | [**IMDB**](#function-imdb-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**IMDB**](#function-imdb-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::IMDB::IMDB (
