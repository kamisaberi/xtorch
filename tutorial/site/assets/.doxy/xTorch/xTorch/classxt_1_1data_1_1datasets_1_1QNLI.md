...
# Class xt::data::datasets::QNLI



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**QNLI**](classxt_1_1data_1_1datasets_1_1QNLI.md)
...
| Type | Name |
| ---: | :--- |
|   | [**QNLI**](#function-qnli-14) (const std::string & root) <br> |
|   | [**QNLI**](#function-qnli-24) (const std::string & root, DataMode mode) <br> |
|   | [**QNLI**](#function-qnli-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**QNLI**](#function-qnli-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::QNLI::QNLI (
