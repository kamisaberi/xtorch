...
# Class xt::data::datasets::CommonVoice



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**CommonVoice**](classxt_1_1data_1_1datasets_1_1CommonVoice.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CommonVoice**](#function-commonvoice-14) (const std::string & root) <br> |
|   | [**CommonVoice**](#function-commonvoice-24) (const std::string & root, DataMode mode) <br> |
|   | [**CommonVoice**](#function-commonvoice-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**CommonVoice**](#function-commonvoice-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function CommonVoice [1/4]

```C++
explicit xt::data::datasets::CommonVoice::CommonVoice (
...
### function CommonVoice [2/4]

```C++
xt::data::datasets::CommonVoice::CommonVoice (
    const std::string & root,
    DataMode mode
) 
```
