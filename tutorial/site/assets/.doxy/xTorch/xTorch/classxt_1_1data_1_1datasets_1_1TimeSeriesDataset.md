...
# Class xt::data::datasets::TimeSeriesDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**TimeSeriesDataset**](classxt_1_1data_1_1datasets_1_1TimeSeriesDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**TimeSeriesDataset**](#function-timeseriesdataset-13) (const std::string & file\_path) <br> |
|   | [**TimeSeriesDataset**](#function-timeseriesdataset-23) (const std::string & file\_path, DataMode mode) <br> |
|   | [**TimeSeriesDataset**](#function-timeseriesdataset-33) (const std::string & file\_path, DataMode mode, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function TimeSeriesDataset [1/3]

```C++
xt::data::datasets::TimeSeriesDataset::TimeSeriesDataset (
...
### function TimeSeriesDataset [2/3]
...
### function TimeSeriesDataset [3/3]
