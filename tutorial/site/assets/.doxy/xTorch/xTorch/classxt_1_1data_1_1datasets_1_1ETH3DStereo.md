...
# Class xt::data::datasets::ETH3DStereo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**ETH3DStereo**](classxt_1_1data_1_1datasets_1_1ETH3DStereo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**ETH3DStereo**](#function-eth3dstereo-14) (const std::string & root) <br> |
|   | [**ETH3DStereo**](#function-eth3dstereo-24) (const std::string & root, DataMode mode) <br> |
|   | [**ETH3DStereo**](#function-eth3dstereo-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**ETH3DStereo**](#function-eth3dstereo-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function ETH3DStereo [1/4]

```C++
explicit xt::data::datasets::ETH3DStereo::ETH3DStereo (
...
### function ETH3DStereo [2/4]

```C++
xt::data::datasets::ETH3DStereo::ETH3DStereo (
    const std::string & root,
    DataMode mode
) 
```
