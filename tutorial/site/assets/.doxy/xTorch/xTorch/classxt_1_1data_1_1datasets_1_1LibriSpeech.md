...
# Class xt::data::datasets::LibriSpeech



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**LibriSpeech**](classxt_1_1data_1_1datasets_1_1LibriSpeech.md)
...
| Type | Name |
| ---: | :--- |
|   | [**LibriSpeech**](#function-librispeech-14) (const std::string & root) <br> |
|   | [**LibriSpeech**](#function-librispeech-24) (const std::string & root, DataMode mode) <br> |
|   | [**LibriSpeech**](#function-librispeech-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**LibriSpeech**](#function-librispeech-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function LibriSpeech [1/4]

```C++
explicit xt::data::datasets::LibriSpeech::LibriSpeech (
...
### function LibriSpeech [2/4]

```C++
xt::data::datasets::LibriSpeech::LibriSpeech (
    const std::string & root,
    DataMode mode
) 
```
