...
# Class xt::data::datasets::VCTK



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**VCTK**](classxt_1_1data_1_1datasets_1_1VCTK.md)
...
| Type | Name |
| ---: | :--- |
|   | [**VCTK**](#function-vctk-14) (const std::string & root) <br> |
|   | [**VCTK**](#function-vctk-24) (const std::string & root, DataMode mode) <br> |
|   | [**VCTK**](#function-vctk-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**VCTK**](#function-vctk-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::VCTK::VCTK (
...
------------------------------
The documentation for this class was generated from the following file `/home/kami/Documents/cpp/models/include/datasets/audio-speech/vctk.h`
