...
# Class xt::data::datasets::MULTI



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**MULTI**](classxt_1_1data_1_1datasets_1_1MULTI.md)
...
| Type | Name |
| ---: | :--- |
|   | [**MULTI**](#function-multi-14) (const std::string & root) <br> |
|   | [**MULTI**](#function-multi-24) (const std::string & root, DataMode mode) <br> |
|   | [**MULTI**](#function-multi-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**MULTI**](#function-multi-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::MULTI::MULTI (
