...
# Class xt::data::datasets::SEMEION



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SEMEION**](classxt_1_1data_1_1datasets_1_1SEMEION.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SEMEION**](#function-semeion-14) (const std::string & root) <br> |
|   | [**SEMEION**](#function-semeion-24) (const std::string & root, DataMode mode) <br> |
|   | [**SEMEION**](#function-semeion-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SEMEION**](#function-semeion-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function SEMEION [1/4]

```C++
explicit xt::data::datasets::SEMEION::SEMEION (
...
### function SEMEION [2/4]

```C++
xt::data::datasets::SEMEION::SEMEION (
    const std::string & root,
    DataMode mode
) 
```
