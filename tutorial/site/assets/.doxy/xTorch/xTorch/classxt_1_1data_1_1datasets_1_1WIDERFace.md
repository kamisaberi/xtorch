...
# Class xt::data::datasets::WIDERFace



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**WIDERFace**](classxt_1_1data_1_1datasets_1_1WIDERFace.md)
...
| Type | Name |
| ---: | :--- |
|   | [**WIDERFace**](#function-widerface-14) (const std::string & root) <br> |
|   | [**WIDERFace**](#function-widerface-24) (const std::string & root, DataMode mode) <br> |
|   | [**WIDERFace**](#function-widerface-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**WIDERFace**](#function-widerface-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function WIDERFace [1/4]

```C++
explicit xt::data::datasets::WIDERFace::WIDERFace (
...
### function WIDERFace [2/4]

```C++
xt::data::datasets::WIDERFace::WIDERFace (
    const std::string & root,
    DataMode mode
) 
```
