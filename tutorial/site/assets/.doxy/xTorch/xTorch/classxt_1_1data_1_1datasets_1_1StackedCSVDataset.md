...
# Class xt::data::datasets::StackedCSVDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**StackedCSVDataset**](classxt_1_1data_1_1datasets_1_1StackedCSVDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**StackedCSVDataset**](#function-stackedcsvdataset-14) (const std::string & folder\_path) <br> |
|   | [**StackedCSVDataset**](#function-stackedcsvdataset-24) (const std::string & folder\_path, DataMode mode) <br> |
|   | [**StackedCSVDataset**](#function-stackedcsvdataset-34) (const std::string & folder\_path, DataMode mode, bool load\_sub\_folders) <br> |
|   | [**StackedCSVDataset**](#function-stackedcsvdataset-44) (const std::string & folder\_path, DataMode mode, bool load\_sub\_folders, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function StackedCSVDataset [1/4]

```C++
xt::data::datasets::StackedCSVDataset::StackedCSVDataset (
...
### function StackedCSVDataset [2/4]
...
### function StackedCSVDataset [3/4]
...
### function StackedCSVDataset [4/4]
