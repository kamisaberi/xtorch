...
# Class xt::data::datasets::CocoDetection



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**CocoDetection**](classxt_1_1data_1_1datasets_1_1CocoDetection.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CocoDetection**](#function-cocodetection-14) (const std::string & root) <br> |
|   | [**CocoDetection**](#function-cocodetection-24) (const std::string & root, DataMode mode) <br> |
|   | [**CocoDetection**](#function-cocodetection-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**CocoDetection**](#function-cocodetection-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function CocoDetection [1/4]

```C++
explicit xt::data::datasets::CocoDetection::CocoDetection (
...
### function CocoDetection [2/4]

```C++
xt::data::datasets::CocoDetection::CocoDetection (
    const std::string & root,
    DataMode mode
) 
```
