...
# Class xt::data::datasets::Tedlium



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Tedlium**](classxt_1_1data_1_1datasets_1_1Tedlium.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Tedlium**](#function-tedlium-14) (const std::string & root) <br> |
|   | [**Tedlium**](#function-tedlium-24) (const std::string & root, DataMode mode) <br> |
|   | [**Tedlium**](#function-tedlium-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Tedlium**](#function-tedlium-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Tedlium [1/4]

```C++
explicit xt::data::datasets::Tedlium::Tedlium (
...
### function Tedlium [2/4]

```C++
xt::data::datasets::Tedlium::Tedlium (
    const std::string & root,
    DataMode mode
) 
```
