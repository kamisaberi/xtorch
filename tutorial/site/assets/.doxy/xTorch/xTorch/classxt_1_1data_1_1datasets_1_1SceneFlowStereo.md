...
# Class xt::data::datasets::SceneFlowStereo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SceneFlowStereo**](classxt_1_1data_1_1datasets_1_1SceneFlowStereo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SceneFlowStereo**](#function-sceneflowstereo-14) (const std::string & root) <br> |
|   | [**SceneFlowStereo**](#function-sceneflowstereo-24) (const std::string & root, DataMode mode) <br> |
|   | [**SceneFlowStereo**](#function-sceneflowstereo-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SceneFlowStereo**](#function-sceneflowstereo-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function SceneFlowStereo [1/4]

```C++
explicit xt::data::datasets::SceneFlowStereo::SceneFlowStereo (
...
### function SceneFlowStereo [2/4]

```C++
xt::data::datasets::SceneFlowStereo::SceneFlowStereo (
    const std::string & root,
    DataMode mode
) 
```
