...
# Class xt::data::datasets::USPS



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**USPS**](classxt_1_1data_1_1datasets_1_1USPS.md)
...
| Type | Name |
| ---: | :--- |
|   | [**USPS**](#function-usps-14) (const std::string & root) <br> |
|   | [**USPS**](#function-usps-24) (const std::string & root, DataMode mode) <br> |
|   | [**USPS**](#function-usps-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**USPS**](#function-usps-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::USPS::USPS (
