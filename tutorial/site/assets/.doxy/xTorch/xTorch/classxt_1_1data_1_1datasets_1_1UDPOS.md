...
# Class xt::data::datasets::UDPOS



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**UDPOS**](classxt_1_1data_1_1datasets_1_1UDPOS.md)
...
| Type | Name |
| ---: | :--- |
|   | [**UDPOS**](#function-udpos-14) (const std::string & root) <br> |
|   | [**UDPOS**](#function-udpos-24) (const std::string & root, DataMode mode) <br> |
|   | [**UDPOS**](#function-udpos-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**UDPOS**](#function-udpos-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::UDPOS::UDPOS (
