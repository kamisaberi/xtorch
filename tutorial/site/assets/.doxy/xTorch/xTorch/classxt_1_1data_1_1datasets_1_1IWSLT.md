...
# Class xt::data::datasets::IWSLT



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**IWSLT**](classxt_1_1data_1_1datasets_1_1IWSLT.md)
...
| Type | Name |
| ---: | :--- |
|   | [**IWSLT**](#function-iwslt-14) (const std::string & root) <br> |
|   | [**IWSLT**](#function-iwslt-24) (const std::string & root, DataMode mode) <br> |
|   | [**IWSLT**](#function-iwslt-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**IWSLT**](#function-iwslt-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::IWSLT::IWSLT (
