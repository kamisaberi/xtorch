...
# Class xt::data::datasets::OxfordIIITPet



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**OxfordIIITPet**](classxt_1_1data_1_1datasets_1_1OxfordIIITPet.md)
...
| Type | Name |
| ---: | :--- |
|   | [**OxfordIIITPet**](#function-oxfordiiitpet-14) (const std::string & root) <br> |
|   | [**OxfordIIITPet**](#function-oxfordiiitpet-24) (const std::string & root, DataMode mode) <br> |
|   | [**OxfordIIITPet**](#function-oxfordiiitpet-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**OxfordIIITPet**](#function-oxfordiiitpet-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function OxfordIIITPet [1/4]

```C++
explicit xt::data::datasets::OxfordIIITPet::OxfordIIITPet (
...
### function OxfordIIITPet [2/4]

```C++
xt::data::datasets::OxfordIIITPet::OxfordIIITPet (
    const std::string & root,
    DataMode mode
) 
```
