...
# Class xt::data::datasets::SBDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SBDataset**](classxt_1_1data_1_1datasets_1_1SBDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SBDataset**](#function-sbdataset-14) (const std::string & root) <br> |
|   | [**SBDataset**](#function-sbdataset-24) (const std::string & root, DataMode mode) <br> |
|   | [**SBDataset**](#function-sbdataset-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SBDataset**](#function-sbdataset-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function SBDataset [1/4]

```C++
explicit xt::data::datasets::SBDataset::SBDataset (
...
### function SBDataset [2/4]

```C++
xt::data::datasets::SBDataset::SBDataset (
    const std::string & root,
    DataMode mode
) 
```
