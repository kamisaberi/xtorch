...
# Class xt::data::datasets::YesNo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**YesNo**](classxt_1_1data_1_1datasets_1_1YesNo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**YesNo**](#function-yesno-14) (const std::string & root) <br> |
|   | [**YesNo**](#function-yesno-24) (const std::string & root, DataMode mode) <br> |
|   | [**YesNo**](#function-yesno-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**YesNo**](#function-yesno-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::YesNo::YesNo (
