...
# Class xt::data::datasets::Cityscapes



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Cityscapes**](classxt_1_1data_1_1datasets_1_1Cityscapes.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Cityscapes**](#function-cityscapes-14) (const std::string & root) <br> |
|   | [**Cityscapes**](#function-cityscapes-24) (const std::string & root, DataMode mode) <br> |
|   | [**Cityscapes**](#function-cityscapes-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Cityscapes**](#function-cityscapes-44) (const std::string & root, DataMode mode, bool download, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function Cityscapes [1/4]

```C++
explicit xt::data::datasets::Cityscapes::Cityscapes (
...
### function Cityscapes [2/4]

```C++
xt::data::datasets::Cityscapes::Cityscapes (
    const std::string & root,
    DataMode mode
) 
```
