...
# Class xt::data::datasets::INaturalist



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**INaturalist**](classxt_1_1data_1_1datasets_1_1INaturalist.md)
...
| Type | Name |
| ---: | :--- |
|   | [**INaturalist**](#function-inaturalist-14) (const std::string & root) <br> |
|   | [**INaturalist**](#function-inaturalist-24) (const std::string & root, DataMode mode) <br> |
|   | [**INaturalist**](#function-inaturalist-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**INaturalist**](#function-inaturalist-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function INaturalist [1/4]

```C++
explicit xt::data::datasets::INaturalist::INaturalist (
...
### function INaturalist [2/4]

```C++
xt::data::datasets::INaturalist::INaturalist (
    const std::string & root,
    DataMode mode
) 
```
