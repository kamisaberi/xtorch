...
# Class xt::data::datasets::PhotoTour



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**PhotoTour**](classxt_1_1data_1_1datasets_1_1PhotoTour.md)
...
| Type | Name |
| ---: | :--- |
|   | [**PhotoTour**](#function-phototour-14) (const std::string & root) <br> |
|   | [**PhotoTour**](#function-phototour-24) (const std::string & root, DataMode mode) <br> |
|   | [**PhotoTour**](#function-phototour-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**PhotoTour**](#function-phototour-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function PhotoTour [1/4]

```C++
explicit xt::data::datasets::PhotoTour::PhotoTour (
...
### function PhotoTour [2/4]

```C++
xt::data::datasets::PhotoTour::PhotoTour (
    const std::string & root,
    DataMode mode
) 
```
