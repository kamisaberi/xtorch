...
# Class xt::data::datasets::Places365



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Places365**](classxt_1_1data_1_1datasets_1_1Places365.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Places365**](#function-places365-14) (const std::string & root) <br> |
|   | [**Places365**](#function-places365-24) (const std::string & root, DataMode mode) <br> |
|   | [**Places365**](#function-places365-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Places365**](#function-places365-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Places365 [1/4]

```C++
explicit xt::data::datasets::Places365::Places365 (
...
### function Places365 [2/4]

```C++
xt::data::datasets::Places365::Places365 (
    const std::string & root,
    DataMode mode
) 
```
...
------------------------------
The documentation for this class was generated from the following file `/home/kami/Documents/cpp/models/include/datasets/image-classification/places.h`
