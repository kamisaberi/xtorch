...
# Class xt::data::datasets::LjSpeech



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**LjSpeech**](classxt_1_1data_1_1datasets_1_1LjSpeech.md)
...
| Type | Name |
| ---: | :--- |
|   | [**LjSpeech**](#function-ljspeech-14) (const std::string & root) <br> |
|   | [**LjSpeech**](#function-ljspeech-24) (const std::string & root, DataMode mode) <br> |
|   | [**LjSpeech**](#function-ljspeech-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**LjSpeech**](#function-ljspeech-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function LjSpeech [1/4]

```C++
explicit xt::data::datasets::LjSpeech::LjSpeech (
...
### function LjSpeech [2/4]

```C++
xt::data::datasets::LjSpeech::LjSpeech (
    const std::string & root,
    DataMode mode
) 
```
