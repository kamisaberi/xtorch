...
# Class xt::data::datasets::MRPC



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**MRPC**](classxt_1_1data_1_1datasets_1_1MRPC.md)
...
| Type | Name |
| ---: | :--- |
|   | [**MRPC**](#function-mrpc-14) (const std::string & root) <br> |
|   | [**MRPC**](#function-mrpc-24) (const std::string & root, DataMode mode) <br> |
|   | [**MRPC**](#function-mrpc-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**MRPC**](#function-mrpc-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::MRPC::MRPC (
