...
# Class xt::data::datasets::HD1K



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**HD1K**](classxt_1_1data_1_1datasets_1_1HD1K.md)
...
| Type | Name |
| ---: | :--- |
|   | [**HD1K**](#function-hd1k-14) (const std::string & root) <br> |
|   | [**HD1K**](#function-hd1k-24) (const std::string & root, DataMode mode) <br> |
|   | [**HD1K**](#function-hd1k-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**HD1K**](#function-hd1k-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::HD1K::HD1K (
