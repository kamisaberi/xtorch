...
# Class xt::data::datasets::SNLI



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SNLI**](classxt_1_1data_1_1datasets_1_1SNLI.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SNLI**](#function-snli-14) (const std::string & root) <br> |
|   | [**SNLI**](#function-snli-24) (const std::string & root, DataMode mode) <br> |
|   | [**SNLI**](#function-snli-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SNLI**](#function-snli-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::SNLI::SNLI (
