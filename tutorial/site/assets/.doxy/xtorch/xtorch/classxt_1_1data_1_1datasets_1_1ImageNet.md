...
# Class xt::data::datasets::ImageNet



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**ImageNet**](classxt_1_1data_1_1datasets_1_1ImageNet.md)
...
| Type | Name |
| ---: | :--- |
|   | [**ImageNet**](#function-imagenet-14) (const std::string & root) <br> |
|   | [**ImageNet**](#function-imagenet-24) (const std::string & root, DataMode mode) <br> |
|   | [**ImageNet**](#function-imagenet-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**ImageNet**](#function-imagenet-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function ImageNet [1/4]

```C++
explicit xt::data::datasets::ImageNet::ImageNet (
...
### function ImageNet [2/4]

```C++
xt::data::datasets::ImageNet::ImageNet (
    const std::string & root,
    DataMode mode
) 
```
