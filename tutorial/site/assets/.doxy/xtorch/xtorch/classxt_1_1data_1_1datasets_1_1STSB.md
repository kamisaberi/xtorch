...
# Class xt::data::datasets::STSB



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**STSB**](classxt_1_1data_1_1datasets_1_1STSB.md)
...
| Type | Name |
| ---: | :--- |
|   | [**STSB**](#function-stsb-14) (const std::string & root) <br> |
|   | [**STSB**](#function-stsb-24) (const std::string & root, DataMode mode) <br> |
|   | [**STSB**](#function-stsb-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**STSB**](#function-stsb-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::STSB::STSB (
