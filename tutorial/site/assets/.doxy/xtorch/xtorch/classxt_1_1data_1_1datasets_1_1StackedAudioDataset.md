...
# Class xt::data::datasets::StackedAudioDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**StackedAudioDataset**](classxt_1_1data_1_1datasets_1_1StackedAudioDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**StackedAudioDataset**](#function-stackedaudiodataset-14) (const std::string & folder\_path) <br> |
|   | [**StackedAudioDataset**](#function-stackedaudiodataset-24) (const std::string & folder\_path, DataMode mode) <br> |
|   | [**StackedAudioDataset**](#function-stackedaudiodataset-34) (const std::string & folder\_path, DataMode mode, bool load\_sub\_folders) <br> |
|   | [**StackedAudioDataset**](#function-stackedaudiodataset-44) (const std::string & folder\_path, DataMode mode, bool load\_sub\_folders, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function StackedAudioDataset [1/4]

```C++
xt::data::datasets::StackedAudioDataset::StackedAudioDataset (
...
### function StackedAudioDataset [2/4]
...
### function StackedAudioDataset [3/4]
...
### function StackedAudioDataset [4/4]
