...
# Class xt::data::datasets::MovingMNIST



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**MovingMNIST**](classxt_1_1data_1_1datasets_1_1MovingMNIST.md)
...
| Type | Name |
| ---: | :--- |
|   | [**MovingMNIST**](#function-movingmnist-14) (const std::string & root) <br> |
|   | [**MovingMNIST**](#function-movingmnist-24) (const std::string & root, DataMode mode) <br> |
|   | [**MovingMNIST**](#function-movingmnist-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**MovingMNIST**](#function-movingmnist-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function MovingMNIST [1/4]

```C++
explicit xt::data::datasets::MovingMNIST::MovingMNIST (
...
### function MovingMNIST [2/4]

```C++
xt::data::datasets::MovingMNIST::MovingMNIST (
    const std::string & root,
    DataMode mode
) 
```
