...
# Class xt::data::datasets::RTE



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**RTE**](classxt_1_1data_1_1datasets_1_1RTE.md)
...
| Type | Name |
| ---: | :--- |
|   | [**RTE**](#function-rte-14) (const std::string & root) <br> |
|   | [**RTE**](#function-rte-24) (const std::string & root, DataMode mode) <br> |
|   | [**RTE**](#function-rte-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**RTE**](#function-rte-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::RTE::RTE (
