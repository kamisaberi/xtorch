...
# Class xt::data::datasets::CremaD



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**CremaD**](classxt_1_1data_1_1datasets_1_1CremaD.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CremaD**](#function-cremad-14) (const std::string & root) <br> |
|   | [**CremaD**](#function-cremad-24) (const std::string & root, DataMode mode) <br> |
|   | [**CremaD**](#function-cremad-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**CremaD**](#function-cremad-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::CremaD::CremaD (
...
```C++
xt::data::datasets::CremaD::CremaD (
    const std::string & root,
    DataMode mode
) 
```
