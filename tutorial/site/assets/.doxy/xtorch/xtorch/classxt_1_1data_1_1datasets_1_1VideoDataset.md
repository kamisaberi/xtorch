...
# Class xt::data::datasets::VideoDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**VideoDataset**](classxt_1_1data_1_1datasets_1_1VideoDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**VideoDataset**](#function-videodataset-13) (const std::string & file\_path) <br> |
|   | [**VideoDataset**](#function-videodataset-23) (const std::string & file\_path, DataMode mode) <br> |
|   | [**VideoDataset**](#function-videodataset-33) (const std::string & file\_path, DataMode mode, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function VideoDataset [1/3]

```C++
xt::data::datasets::VideoDataset::VideoDataset (
