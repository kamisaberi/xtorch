...
# Class xt::data::datasets::Flowers102



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Flowers102**](classxt_1_1data_1_1datasets_1_1Flowers102.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Flowers102**](#function-flowers102-14) (const std::string & root) <br> |
|   | [**Flowers102**](#function-flowers102-24) (const std::string & root, DataMode mode) <br> |
|   | [**Flowers102**](#function-flowers102-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Flowers102**](#function-flowers102-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Flowers102 [1/4]

```C++
explicit xt::data::datasets::Flowers102::Flowers102 (
...
### function Flowers102 [2/4]

```C++
xt::data::datasets::Flowers102::Flowers102 (
    const std::string & root,
    DataMode mode
) 
```
...
------------------------------
The documentation for this class was generated from the following file `/home/kami/Documents/cpp/models/include/datasets/image-classification/flowers.h`
