...
# Class xt::data::datasets::Kitti2012Stereo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Kitti2012Stereo**](classxt_1_1data_1_1datasets_1_1Kitti2012Stereo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Kitti2012Stereo**](#function-kitti2012stereo-14) (const std::string & root) <br> |
|   | [**Kitti2012Stereo**](#function-kitti2012stereo-24) (const std::string & root, DataMode mode) <br> |
|   | [**Kitti2012Stereo**](#function-kitti2012stereo-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Kitti2012Stereo**](#function-kitti2012stereo-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Kitti2012Stereo [1/4]

```C++
explicit xt::data::datasets::Kitti2012Stereo::Kitti2012Stereo (
...
### function Kitti2012Stereo [2/4]

```C++
xt::data::datasets::Kitti2012Stereo::Kitti2012Stereo (
    const std::string & root,
    DataMode mode
) 
```
