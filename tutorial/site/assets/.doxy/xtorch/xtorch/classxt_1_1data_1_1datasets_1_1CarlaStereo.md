...
# Class xt::data::datasets::CarlaStereo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**CarlaStereo**](classxt_1_1data_1_1datasets_1_1CarlaStereo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CarlaStereo**](#function-carlastereo-14) (const std::string & root) <br> |
|   | [**CarlaStereo**](#function-carlastereo-24) (const std::string & root, DataMode mode) <br> |
|   | [**CarlaStereo**](#function-carlastereo-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**CarlaStereo**](#function-carlastereo-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function CarlaStereo [1/4]

```C++
explicit xt::data::datasets::CarlaStereo::CarlaStereo (
...
### function CarlaStereo [2/4]

```C++
xt::data::datasets::CarlaStereo::CarlaStereo (
    const std::string & root,
    DataMode mode
) 
```
