...
# Class xt::data::datasets::RenderedSST2



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**RenderedSST2**](classxt_1_1data_1_1datasets_1_1RenderedSST2.md)
...
| Type | Name |
| ---: | :--- |
|   | [**RenderedSST2**](#function-renderedsst2-14) (const std::string & root) <br> |
|   | [**RenderedSST2**](#function-renderedsst2-24) (const std::string & root, DataMode mode) <br> |
|   | [**RenderedSST2**](#function-renderedsst2-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**RenderedSST2**](#function-renderedsst2-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function RenderedSST2 [1/4]

```C++
explicit xt::data::datasets::RenderedSST2::RenderedSST2 (
...
### function RenderedSST2 [2/4]

```C++
xt::data::datasets::RenderedSST2::RenderedSST2 (
    const std::string & root,
    DataMode mode
) 
```
