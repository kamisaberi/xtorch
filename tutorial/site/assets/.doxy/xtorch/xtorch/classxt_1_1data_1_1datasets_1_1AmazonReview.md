...
# Class xt::data::datasets::AmazonReview



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**AmazonReview**](classxt_1_1data_1_1datasets_1_1AmazonReview.md)
...
| Type | Name |
| ---: | :--- |
|   | [**AmazonReview**](#function-amazonreview-14) (const std::string & root) <br> |
|   | [**AmazonReview**](#function-amazonreview-24) (const std::string & root, DataMode mode) <br> |
|   | [**AmazonReview**](#function-amazonreview-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**AmazonReview**](#function-amazonreview-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function AmazonReview [1/4]

```C++
explicit xt::data::datasets::AmazonReview::AmazonReview (
...
### function AmazonReview [2/4]

```C++
xt::data::datasets::AmazonReview::AmazonReview (
    const std::string & root,
    DataMode mode
) 
```
