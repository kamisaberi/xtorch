...
# Class xt::data::datasets::KittiFlow



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**KittiFlow**](classxt_1_1data_1_1datasets_1_1KittiFlow.md)
...
| Type | Name |
| ---: | :--- |
|   | [**KittiFlow**](#function-kittiflow-14) (const std::string & root) <br> |
|   | [**KittiFlow**](#function-kittiflow-24) (const std::string & root, DataMode mode) <br> |
|   | [**KittiFlow**](#function-kittiflow-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**KittiFlow**](#function-kittiflow-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function KittiFlow [1/4]

```C++
explicit xt::data::datasets::KittiFlow::KittiFlow (
...
### function KittiFlow [2/4]

```C++
xt::data::datasets::KittiFlow::KittiFlow (
    const std::string & root,
    DataMode mode
) 
```
