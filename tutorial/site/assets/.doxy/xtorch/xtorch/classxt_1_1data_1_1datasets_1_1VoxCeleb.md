...
# Class xt::data::datasets::VoxCeleb



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**VoxCeleb**](classxt_1_1data_1_1datasets_1_1VoxCeleb.md)
...
| Type | Name |
| ---: | :--- |
|   | [**VoxCeleb**](#function-voxceleb-14) (const std::string & root) <br> |
|   | [**VoxCeleb**](#function-voxceleb-24) (const std::string & root, DataMode mode) <br> |
|   | [**VoxCeleb**](#function-voxceleb-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**VoxCeleb**](#function-voxceleb-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function VoxCeleb [1/4]

```C++
explicit xt::data::datasets::VoxCeleb::VoxCeleb (
...
### function VoxCeleb [2/4]

```C++
xt::data::datasets::VoxCeleb::VoxCeleb (
    const std::string & root,
    DataMode mode
) 
```
