...
# Class xt::data::datasets::YahooAnswers



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**YahooAnswers**](classxt_1_1data_1_1datasets_1_1YahooAnswers.md)
...
| Type | Name |
| ---: | :--- |
|   | [**YahooAnswers**](#function-yahooanswers-14) (const std::string & root) <br> |
|   | [**YahooAnswers**](#function-yahooanswers-24) (const std::string & root, DataMode mode) <br> |
|   | [**YahooAnswers**](#function-yahooanswers-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**YahooAnswers**](#function-yahooanswers-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function YahooAnswers [1/4]

```C++
explicit xt::data::datasets::YahooAnswers::YahooAnswers (
...
### function YahooAnswers [2/4]

```C++
xt::data::datasets::YahooAnswers::YahooAnswers (
    const std::string & root,
    DataMode mode
) 
```
