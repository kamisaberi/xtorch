...
# Class xt::data::datasets::VOCSegmentation



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**VOCSegmentation**](classxt_1_1data_1_1datasets_1_1VOCSegmentation.md)
...
| Type | Name |
| ---: | :--- |
|   | [**VOCSegmentation**](#function-vocsegmentation-14) (const std::string & root) <br> |
|   | [**VOCSegmentation**](#function-vocsegmentation-24) (const std::string & root, DataMode mode) <br> |
|   | [**VOCSegmentation**](#function-vocsegmentation-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**VOCSegmentation**](#function-vocsegmentation-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function VOCSegmentation [1/4]

```C++
explicit xt::data::datasets::VOCSegmentation::VOCSegmentation (
...
### function VOCSegmentation [2/4]

```C++
xt::data::datasets::VOCSegmentation::VOCSegmentation (
    const std::string & root,
    DataMode mode
) 
```
