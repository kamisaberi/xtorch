...
# Class xt::data::datasets::Middlebury2014Stereo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Middlebury2014Stereo**](classxt_1_1data_1_1datasets_1_1Middlebury2014Stereo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Middlebury2014Stereo**](#function-middlebury2014stereo-14) (const std::string & root) <br> |
|   | [**Middlebury2014Stereo**](#function-middlebury2014stereo-24) (const std::string & root, DataMode mode) <br> |
|   | [**Middlebury2014Stereo**](#function-middlebury2014stereo-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Middlebury2014Stereo**](#function-middlebury2014stereo-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function Middlebury2014Stereo [1/4]

```C++
explicit xt::data::datasets::Middlebury2014Stereo::Middlebury2014Stereo (
...
### function Middlebury2014Stereo [2/4]

```C++
xt::data::datasets::Middlebury2014Stereo::Middlebury2014Stereo (
    const std::string & root,
    DataMode mode
) 
```
...
### function Middlebury2014Stereo [3/4]
...
### function Middlebury2014Stereo [4/4]
