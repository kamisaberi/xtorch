...
# Class xt::data::datasets::SUN397



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SUN397**](classxt_1_1data_1_1datasets_1_1SUN397.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SUN397**](#function-sun397-14) (const std::string & root) <br> |
|   | [**SUN397**](#function-sun397-24) (const std::string & root, DataMode mode) <br> |
|   | [**SUN397**](#function-sun397-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SUN397**](#function-sun397-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::SUN397::SUN397 (
...
```C++
xt::data::datasets::SUN397::SUN397 (
    const std::string & root,
    DataMode mode
) 
```
