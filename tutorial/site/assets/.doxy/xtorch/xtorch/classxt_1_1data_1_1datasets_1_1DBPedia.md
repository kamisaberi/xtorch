...
# Class xt::data::datasets::DBPedia



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**DBPedia**](classxt_1_1data_1_1datasets_1_1DBPedia.md)
...
| Type | Name |
| ---: | :--- |
|   | [**DBPedia**](#function-dbpedia-14) (const std::string & root) <br> |
|   | [**DBPedia**](#function-dbpedia-24) (const std::string & root, DataMode mode) <br> |
|   | [**DBPedia**](#function-dbpedia-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**DBPedia**](#function-dbpedia-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function DBPedia [1/4]

```C++
explicit xt::data::datasets::DBPedia::DBPedia (
...
### function DBPedia [2/4]

```C++
xt::data::datasets::DBPedia::DBPedia (
    const std::string & root,
    DataMode mode
) 
```
