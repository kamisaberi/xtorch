...
# Class xt::data::datasets::AgNews



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**AgNews**](classxt_1_1data_1_1datasets_1_1AgNews.md)
...
| Type | Name |
| ---: | :--- |
|   | [**AgNews**](#function-agnews-14) (const std::string & root) <br> |
|   | [**AgNews**](#function-agnews-24) (const std::string & root, DataMode mode) <br> |
|   | [**AgNews**](#function-agnews-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**AgNews**](#function-agnews-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::AgNews::AgNews (
...
```C++
xt::data::datasets::AgNews::AgNews (
    const std::string & root,
    DataMode mode
) 
```
