...
# Class xt::data::datasets::Imagenette



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Imagenette**](classxt_1_1data_1_1datasets_1_1Imagenette.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Imagenette**](#function-imagenette-15) (const std::string & root) <br> |
|   | [**Imagenette**](#function-imagenette-25) (const std::string & root, DataMode mode) <br> |
|   | [**Imagenette**](#function-imagenette-35) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Imagenette**](#function-imagenette-45) (const std::string & root, DataMode mode, bool download, ImageType type) <br> |
|   | [**Imagenette**](#function-imagenette-55) (const std::string & root, DataMode mode, bool download, ImageType type, TransformType transforms) <br> |
...
### function Imagenette [1/5]

```C++
explicit xt::data::datasets::Imagenette::Imagenette (
...
### function Imagenette [2/5]

```C++
xt::data::datasets::Imagenette::Imagenette (
    const std::string & root,
    DataMode mode
) 
```
