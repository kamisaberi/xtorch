...
# Class xt::data::datasets::CREStereo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**CREStereo**](classxt_1_1data_1_1datasets_1_1CREStereo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CREStereo**](#function-crestereo-14) (const std::string & root) <br> |
|   | [**CREStereo**](#function-crestereo-24) (const std::string & root, DataMode mode) <br> |
|   | [**CREStereo**](#function-crestereo-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**CREStereo**](#function-crestereo-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function CREStereo [1/4]

```C++
explicit xt::data::datasets::CREStereo::CREStereo (
...
### function CREStereo [2/4]

```C++
xt::data::datasets::CREStereo::CREStereo (
    const std::string & root,
    DataMode mode
) 
```
