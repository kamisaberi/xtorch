...
# Class xt::data::datasets::Flickr30k



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Flickr30k**](classxt_1_1data_1_1datasets_1_1Flickr30k.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Flickr30k**](#function-flickr30k-12) (const std::string & root, DataMode mode=DataMode::TRAIN, bool download=false) <br> |
|   | [**Flickr30k**](#function-flickr30k-22) (const fs::path & root, [**DatasetArguments**](structDatasetArguments.md) args) <br> |
...
### function Flickr30k [1/2]

```C++
xt::data::datasets::Flickr30k::Flickr30k (
