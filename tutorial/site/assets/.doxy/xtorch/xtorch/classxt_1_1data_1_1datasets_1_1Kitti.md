...
# Class xt::data::datasets::Kitti



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**Kitti**](classxt_1_1data_1_1datasets_1_1Kitti.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Kitti**](#function-kitti-14) (const std::string & root) <br> |
|   | [**Kitti**](#function-kitti-24) (const std::string & root, DataMode mode) <br> |
|   | [**Kitti**](#function-kitti-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**Kitti**](#function-kitti-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::Kitti::Kitti (
