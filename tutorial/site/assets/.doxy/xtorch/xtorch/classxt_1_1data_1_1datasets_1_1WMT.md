...
# Class xt::data::datasets::WMT



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**WMT**](classxt_1_1data_1_1datasets_1_1WMT.md)
...
| Type | Name |
| ---: | :--- |
|   | [**WMT**](#function-wmt-14) (const std::string & root) <br> |
|   | [**WMT**](#function-wmt-24) (const std::string & root, DataMode mode) <br> |
|   | [**WMT**](#function-wmt-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**WMT**](#function-wmt-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::WMT::WMT (
