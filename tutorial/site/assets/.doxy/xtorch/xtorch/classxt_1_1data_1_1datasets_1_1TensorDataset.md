...
# Class xt::data::datasets::TensorDataset



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**TensorDataset**](classxt_1_1data_1_1datasets_1_1TensorDataset.md)
...
| Type | Name |
| ---: | :--- |
|   | [**TensorDataset**](#function-tensordataset-13) (const std::string & file\_path) <br> |
|   | [**TensorDataset**](#function-tensordataset-23) (const std::string & file\_path, DataMode mode) <br> |
|   | [**TensorDataset**](#function-tensordataset-33) (const std::string & file\_path, DataMode mode, vector&lt; std::function&lt; torch::Tensor(torch::Tensor)&gt; &gt; transforms) <br> |
...
### function TensorDataset [1/3]

```C++
xt::data::datasets::TensorDataset::TensorDataset (
