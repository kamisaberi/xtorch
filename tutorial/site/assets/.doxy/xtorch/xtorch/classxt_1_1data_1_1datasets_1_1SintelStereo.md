...
# Class xt::data::datasets::SintelStereo



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**SintelStereo**](classxt_1_1data_1_1datasets_1_1SintelStereo.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SintelStereo**](#function-sintelstereo-14) (const std::string & root) <br> |
|   | [**SintelStereo**](#function-sintelstereo-24) (const std::string & root, DataMode mode) <br> |
|   | [**SintelStereo**](#function-sintelstereo-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**SintelStereo**](#function-sintelstereo-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function SintelStereo [1/4]

```C++
xt::data::datasets::SintelStereo::SintelStereo (
