...
# Class xt::data::datasets::EuroSAT



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**EuroSAT**](classxt_1_1data_1_1datasets_1_1EuroSAT.md)
...
| Type | Name |
| ---: | :--- |
|   | [**EuroSAT**](#function-eurosat-14) (const std::string & root) <br> |
|   | [**EuroSAT**](#function-eurosat-24) (const std::string & root, DataMode mode) <br> |
|   | [**EuroSAT**](#function-eurosat-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**EuroSAT**](#function-eurosat-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
### function EuroSAT [1/4]

```C++
explicit xt::data::datasets::EuroSAT::EuroSAT (
...
### function EuroSAT [2/4]

```C++
xt::data::datasets::EuroSAT::EuroSAT (
    const std::string & root,
    DataMode mode
) 
```
