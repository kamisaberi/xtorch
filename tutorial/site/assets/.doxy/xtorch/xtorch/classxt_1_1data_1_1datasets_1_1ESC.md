...
# Class xt::data::datasets::ESC



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**ESC**](classxt_1_1data_1_1datasets_1_1ESC.md)
...
| Type | Name |
| ---: | :--- |
|   | [**ESC**](#function-esc-14) (const std::string & root) <br> |
|   | [**ESC**](#function-esc-24) (const std::string & root, DataMode mode) <br> |
|   | [**ESC**](#function-esc-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**ESC**](#function-esc-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::ESC::ESC (
