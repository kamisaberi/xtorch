...
# Class xt::data::datasets::GTZAN



[**ClassList**](annotated.md) **>** [**xt**](namespacext.md) **>** [**data**](namespacext_1_1data.md) **>** [**datasets**](namespacext_1_1data_1_1datasets.md) **>** [**GTZAN**](classxt_1_1data_1_1datasets_1_1GTZAN.md)
...
| Type | Name |
| ---: | :--- |
|   | [**GTZAN**](#function-gtzan-14) (const std::string & root) <br> |
|   | [**GTZAN**](#function-gtzan-24) (const std::string & root, DataMode mode) <br> |
|   | [**GTZAN**](#function-gtzan-34) (const std::string & root, DataMode mode, bool download) <br> |
|   | [**GTZAN**](#function-gtzan-44) (const std::string & root, DataMode mode, bool download, TransformType transforms) <br> |
...
```C++
explicit xt::data::datasets::GTZAN::GTZAN (
