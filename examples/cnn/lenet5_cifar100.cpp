...
/**
 * @brief Main function to train a LeNet5 model on the CIFAR-100 dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize LeNet5 model for 100 classes (CIFAR-100) with 3 input channels (RGB)
