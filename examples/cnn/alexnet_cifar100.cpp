...
/**
 * @brief Main function to train an AlexNet model on the CIFAR-100 dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize AlexNet model for 100 classes (CIFAR-100) with 3 input channels
