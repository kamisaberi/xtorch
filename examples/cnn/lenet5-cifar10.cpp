...
/**
 * @brief Main function to train a LeNet5 model on the CIFAR-10 dataset using PyTorch.
 *
 ...
 * and trains the model for 10 epochs using negative log likelihood loss. The dataset size is printed,
 * and training progress is logged every 100 batches.
 *
...
int main() {
    ...
    // Initialize LeNet5 model for 10 classes (CIFAR-10) with 3 input channels (RGB)
