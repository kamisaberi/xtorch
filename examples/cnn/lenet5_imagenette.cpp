...
/**
 * @brief Main function to train a LeNet5 model on the Imagenette dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize LeNet5 model for 10 classes (Imagenette) with 3 input channels (RGB)
