...
/**
 * @brief Main function to train an AlexNet model on the CIFAR-10 dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize AlexNet model for 10 classes (CIFAR-10) with 3 input channels
