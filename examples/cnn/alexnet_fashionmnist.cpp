...
/**
 * @brief Main function to train an AlexNet model on the FashionMNIST dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize AlexNet model for 10 classes (FashionMNIST) with 1 input channel (grayscale)
