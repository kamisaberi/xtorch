...
/**
 * @brief Main function to train an AlexNet model on the Food101 dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize AlexNet model for 10 classes (subset of Food101) with 3 input channels (RGB)
