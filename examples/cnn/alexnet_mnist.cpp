...
/**
 * @brief Main function to train an AlexNet model on the MNIST dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize AlexNet model for 10 classes (MNIST) with 1 input channel (grayscale)
