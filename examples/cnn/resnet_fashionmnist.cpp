...
/**
 * @brief Main function to train a ResNet18 model on the FashionMNIST dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize ResNet18 model with layer configuration {3, 4, 6, 3} for 10 classes (FashionMNIST) with 1 input channel (grayscale)
