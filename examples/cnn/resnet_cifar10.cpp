...
/**
 * @brief Main function to train a ResNet18 model on the CIFAR-10 dataset using PyTorch.
 *
...
int main() {
    ...
    // Initialize ResNet18 model with layer configuration {3, 4, 6, 3} for 10 classes (CIFAR-10) with 3 input channels (RGB)
