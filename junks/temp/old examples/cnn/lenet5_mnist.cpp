...
/**
 * @brief Main function to train a LeNet5 model on the MNIST dataset using PyTorch.
 *
...
int main() {
    ...
    // Commented-out debug statement to print the selected device
    // cout << device << endl;
    // return 0;

    // Load MNIST training dataset
    // - Path: /home/kami/Documents/datasets/
    // - Mode: Training
    // - Download: Enabled
    auto dataset = xt::datasets::MNIST("/home/kami/Documents/datasets/", DataMode::TRAIN, true);
    ...
    // Create a data loader with sequential sampling and batch size of aciones64
    auto train_loader = torch::data::make_data_loader<torch::data::samplers::SequentialSampler>(
        std::move(transformed_dataset), 64);

    // Initialize LeNet5 model for 10 classes (MNIST)
